# GitHub Copilot Coding Guidelines (V2)
...
- XML-doc all properties and methods (public and non-public). XML-doc all public types. Keep comments meaningful and non-boilerplate.
- Add helpful inline comments, especially for non-obvious logic, concurrency/async flow, and business rules.
...
- Perform low-risk refactoring to improve readability and maintainability (e.g., split complex methods into smaller helpers, extract well-named functions). Do not change observable behavior.
- Avoid default parameter values in public APIs—prefer overloads.
